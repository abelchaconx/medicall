                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 items-center">
                    ...
                    <div class="col-span-1 flex justify-center sm:justify-end">
                        <div class="flex w-full gap-2">
                            ...
                            <a href="{{ route('users.trashed') }}" class="flex-1 w-full inline-flex items-center justify-center bg-gray-700 text-white px-4 py-2 rounded h-10 hover:bg-gray-800 dark:bg-gray-600 dark:text-gray-100">Eliminados</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <tr class="block md:table-row mb-3 md:mb-0 bg-white dark:bg-gray-800 rounded-lg md:rounded-none shadow-sm md:shadow-none overflow-hidden">
                            ...
                            <td class="px-3 py-1 block md:table-cell align-top">
                                <div class="md:hidden flex justify-between items-start">
                                    ...
                                    <span class="">{{ $user->status ?? ($user->trashed() ? 'deleted' : 'active') }}</span>
                                </div>
                                <div class="hidden md:block">
                                    <span class="block">{{ $user->status ?? ($user->trashed() ? 'deleted' : 'active') }}</span>
                                </div>
                            </td>
                            <td class="px-3 py-1 block md:table-cell align-top">
