    ...
    <div class="mb-4">
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 items-center">
            ...
            <div class="col-span-1 flex justify-center sm:justify-end">
                <a href="{{ route('permissions.index') }}" class="inline-flex items-center justify-center px-4 py-2 rounded h-10 bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-gray-100">Volver a permisos</a>
            </div>
        </div>
    </div>
                        ...
                        <tr class="block md:table-row mb-3 md:mb-0 bg-white dark:bg-gray-800 rounded-lg md:rounded-none shadow-sm md:shadow-none overflow-hidden">
                            ...
                            <td class="px-3 py-1 block md:table-cell align-top">
                                <div class="md:hidden flex justify-between items-start">
                                    ...
                                    <span class="text-sm">{{ $p->deleted_at?->diffForHumans() }}</span>
                                </div>
                                <div class="hidden md:block">
                                    <span class="block text-sm">{{ $p->deleted_at?->diffForHumans() }}</span>
                                </div>
                            </td>
                            <td class="px-3 py-1 block md:table-cell align-top">
                                <div class="mt-2 md:mt-0">
                                    <div class="md:hidden flex justify-between items-center">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <button onclick="confirmActionPermissions('restore', {{ $p->id }})" class="inline-flex items-center justify-center w-9 h-9 rounded-full text-white bg-gradient-to-r from-green-500 to-green-600">R</button>
                                        </div>
                                    </div>
                                    <div class="hidden md:flex md:flex-row md:items-center md:gap-2">
                                        <button onclick="confirmActionPermissions('restore', {{ $p->id }})" class="w-full md:w-auto text-sm px-3 py-1 rounded text-white bg-gradient-to-r from-green-500 to-green-600">Restaurar</button>
                                    </div>
                                </div>
                            </td>
                        </tr>
