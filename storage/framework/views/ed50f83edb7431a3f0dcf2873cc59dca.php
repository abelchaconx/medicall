<nav x-data="{ open: false }" class="fixed top-0 inset-x-0 z-50 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
...
<?php endif; ?>
            ...
            <!-- Hamburger -->
                ...
                <button @click="open = ! open; window.dispatchEvent(new CustomEvent('toggle-sidebar'))" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-900 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-900 focus:text-gray-500 dark:focus:text-gray-400 transition duration-150 ease-in-out">
...
<?php /**PATH C:\laragon\www\medicall\resources\views/navigation-menu.blade.php ENDPATH**/ ?>