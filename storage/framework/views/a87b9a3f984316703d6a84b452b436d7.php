<div id="livewire-doctors">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 items-center">
            ...
            <div class="col-span-1 hidden sm:block"></div>
                ...
                <div class="flex w-full gap-2">
                    ...
                    <a href="<?php echo e(route('doctors.trashed')); ?>" class="flex-1 inline-flex items-center justify-center bg-gray-700 text-white px-4 py-2 rounded h-10">
                        Eliminados
                        <!--[if BLOCK]><![endif]--><?php if(isset($trashedCount) && $trashedCount > 0): ?>
                            <span class="ml-2 inline-flex items-center justify-center bg-red-600 text-white text-xs px-2 py-0.5 rounded"><?php echo e($trashedCount ?? 0); ?></span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div>
                    ...
                    <select wire:model.defer="user_id" class="mt-1 block w-full border rounded px-2 py-1 bg-white dark:bg-gray-900 dark:text-gray-200">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $availableUsers ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div>
                    ...
                    <select wire:model.defer="specialty_id" class="mt-1 block w-full border rounded px-2 py-1 bg-white dark:bg-gray-900 dark:text-gray-200">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $availableSpecialties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id); ?>"><?php echo e($name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                    </select>
                </div>
                ...
                <div class="md:col-span-3">
                    ...
                    <select wire:model.defer="medical_office_ids" multiple size="5" class="mt-1 block w-full border rounded px-2 py-1 bg-white dark:bg-gray-900 dark:text-gray-200">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $availableMedicalOffices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id); ?>"><?php echo e($name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                    </select>
                </div>
    ...
    <div class="bg-transparent">
                ...
                <tbody class="md:table-row-group">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="block md:table-row mb-3 md:mb-0 odd:bg-gray-50 even:bg-white dark:odd:bg-gray-800 dark:even:bg-gray-900 rounded-lg md:rounded-none shadow-sm md:shadow-none overflow-hidden">
                            <td class="px-3 py-1"><div class="hidden md:block"><?php echo e($doctor->id); ?></div></td>
                            <td class="px-3 py-1"><?php echo e($doctor->user?->name ?? '—'); ?></td>
                            <td class="px-3 py-1">
                                <div class="text-sm">
                                    <!--[if BLOCK]><![endif]--><?php if($doctor->specialties && $doctor->specialties->isNotEmpty()): ?>
                                        <div class="flex flex-wrap gap-2">
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $doctor->specialties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="text-xs px-2 py-0.5 rounded text-black dark:text-white" style="background: <?php echo e($spec->color_translucent); ?>; border: 1px solid <?php echo e($spec->color); ?>;"><?php echo e($spec->name); ?></span>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                        </div>
                                    <?php else: ?>
                                        —
                            ...
                            <td class="px-3 py-1">
                                <div class="text-sm">
                                    <!--[if BLOCK]><![endif]--><?php if($doctor->medicalOffices && $doctor->medicalOffices->isNotEmpty()): ?>
                                        <ul class="space-y-1">
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $doctor->medicalOffices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $office): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td class="px-3 py-1">
                                <div class="flex items-center gap-2">
                                    <button wire:click="edit(<?php echo e($doctor->id); ?>)" class="px-3 py-1 rounded text-white bg-yellow-400">Editar</button>
                                    
                                    <!--[if BLOCK]><![endif]--><?php if($doctor->trashed()): ?>
                                        <button onclick="confirmAction('restore', <?php echo e($doctor->id); ?>)" class="px-3 py-1 rounded text-white bg-green-600">Restaurar</button>
                                    <?php else: ?>
                                        <button onclick="confirmAction('delete', <?php echo e($doctor->id); ?>)" class="px-3 py-1 rounded text-white bg-red-600">Eliminar</button>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                            </td>
                        </tr>
        ...
        <div class="p-3"><?php echo e($doctors->links()); ?></div>
    </div>
...
<?php /**PATH C:\laragon\www\medicall\resources\views/livewire/doctors.blade.php ENDPATH**/ ?>