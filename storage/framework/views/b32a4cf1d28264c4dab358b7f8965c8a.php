        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 items-center">
            ...
            <div class="col-span-1 flex justify-center sm:justify-end">
                <div class="flex w-full gap-2">
                    ...
                    <a href="<?php echo e(route('permissions.trashed')); ?>" class="flex-1 w-full text-white px-4 py-2 rounded h-10 bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-center">Eliminados</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="w-full overflow-x-auto">
            <table class="min-w-full w-full table-auto text-gray-900 dark:text-gray-100">
                ...
                <tbody class="md:table-row-group">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="mt-2 md:mt-0">
                                    <div class="md:hidden flex justify-between items-center">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <button onclick="confirmActionPermissions('delete', <?php echo e($p->id); ?>)" class="inline-flex items-center justify-center w-9 h-9 rounded-full text-white bg-gradient-to-r from-red-500 to-red-600">Del</button>
                                        </div>
                                    </div>

                                    <div class="hidden md:flex md:flex-row md:items-center md:gap-2">
                                        <button wire:click="edit(<?php echo e($p->id); ?>)" class="w-full md:w-auto text-sm px-3 py-1 rounded text-white bg-gradient-to-r from-yellow-400 to-yellow-500">Editar</button>
                                        <button onclick="confirmActionPermissions('delete', <?php echo e($p->id); ?>)" class="w-full md:w-auto text-sm px-3 py-1 rounded text-white bg-gradient-to-r from-red-500 to-red-600">Eliminar</button>
                                    </div>
                                </div>
                            </td>
                        </tr>
...
<?php /**PATH C:\laragon\www\medicall\resources\views/livewire/permissions.blade.php ENDPATH**/ ?>