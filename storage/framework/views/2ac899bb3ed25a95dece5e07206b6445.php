        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 items-center">
            ...
            <div class="col-span-1 flex justify-center sm:justify-end">
                <div class="flex w-full gap-2">
                    ...
                    <a href="<?php echo e(route('specialties.trashed')); ?>" class="flex-1 w-full inline-flex items-center justify-center bg-gray-700 text-white px-4 py-2 rounded h-10 hover:bg-gray-800 dark:bg-gray-600 dark:text-gray-100">Eliminados</a>
                </div>
            </div>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <div class="bg-transparent">
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $specialties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specialty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td class="px-3 py-1">
                                <div class="md:hidden flex justify-between items-start">
                                    ...
                                    <span class="font-semibold"><?php echo e($specialty->id); ?></span>
                                </div>
                                <div class="hidden md:block"><span class="block font-semibold"><?php echo e($specialty->id); ?></span></div>
                            </td>

                            <td class="px-3 py-1">
                                <div class="md:hidden flex justify-between items-start">
                                    <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Nombre</span>
                                    <span class=""><?php echo e($specialty->name); ?></span>
                                </div>
                                <div class="hidden md:block">
                                    <span class="inline-flex items-center px-2 py-0.5 text-sm rounded text-black dark:text-white" style="background: <?php echo e($specialty->color_translucent); ?>; border: 1px solid <?php echo e($specialty->color); ?>;">
                                        <span style="font-weight:600;"><?php echo e($specialty->name); ?></span>
                                    </span>
                                </div>
                            </td>
                            <td class="px-3 py-1">
                                <div class="md:hidden flex justify-between items-start">
                                    ...
                                    <span class="text-sm truncate max-w-[60%]"><?php echo e($specialty->description ?? '—'); ?></span>
                                </div>
                                <div class="hidden md:block"><span class="block text-sm truncate"><?php echo e($specialty->description ?? '—'); ?></span></div>
                            </td>
                                ...
                                <div class="mt-2 md:mt-0">
                                    <div class="md:hidden flex justify-between items-center">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <button wire:click="edit(<?php echo e($specialty->id); ?>)" class="inline-flex items-center justify-center w-9 h-9 rounded-full text-white bg-gradient-to-r from-yellow-400 to-yellow-500">E</button>
                                        </div>
                                    </div>

                                    <div class="hidden md:flex md:flex-row md:items-center md:gap-2">
                                        <button wire:click="edit(<?php echo e($specialty->id); ?>)" class="w-full md:w-auto text-sm px-3 py-1 rounded text-white bg-gradient-to-r from-yellow-400 to-yellow-500">Editar</button>
                                        <!--[if BLOCK]><![endif]--><?php if(method_exists($specialty, 'trashed') && $specialty->trashed()): ?>
                                            <button onclick="confirmAction('restore', <?php echo e($specialty->id); ?>)" class="w-full md:w-auto text-sm px-3 py-1 rounded text-white bg-gradient-to-r from-green-500 to-green-600">Restaurar</button>
                                        <?php else: ?>
                                            <button onclick="confirmAction('delete', <?php echo e($specialty->id); ?>)" class="w-full md:w-auto text-sm px-3 py-1 rounded text-white bg-gradient-to-r from-red-500 to-red-600">Eliminar</button>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                </div>
                            </td>
        ...
        <div class="p-3"><?php echo e($specialties->links()); ?></div>
    </div>
...
<?php /**PATH C:\laragon\www\medicall\resources\views/livewire/specialties.blade.php ENDPATH**/ ?>